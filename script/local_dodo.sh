...
theuser=ro0zkhosh
user=$(id -u)
loc=/home/$theuser/MemorEDF/lnx_jailhouse
...
source /home/$theuser/Petalinux/settings.sh
petalinux-package --boot --fsbl build/tmp/deploy/images/plnx_aarch64/fsbl-plnx_aarch64.elf --fpga ../HDF/FIQ.bit --pmufw build/tmp/deploy/images/plnx_aarch64/pmu-plnx_aarch64.elf --u-boot build/tmp/deploy/images/plnx_aarch64/u-boot.elf --force
...
if [ "$param" == "-l" ]
then
    cp $cp_opt $loc/images/linux/Image  $loc/images/linux/BOOT.BIN $dest #$loc/images/linux/system.dtb  $dest
