...
################################################################
# This is a generated script based on design: bd_880d
#
...
proc create_hier_cell_s02_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.S_ARUSER_WIDTH {130} \
   CONFIG.S_AWUSER_WIDTH {130} \
...
proc create_hier_cell_s01_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x00000000B0030000} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC005_ROUTE {0b001} \
   CONFIG.SSC006_ROUTE {0b010} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SC_ARUSER_WIDTH {130} \
   CONFIG.SC_AWUSER_WIDTH {130} \
