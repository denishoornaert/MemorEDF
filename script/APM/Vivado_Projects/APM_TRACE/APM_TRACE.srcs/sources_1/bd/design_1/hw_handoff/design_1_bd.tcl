...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_EN_LAST_READ_FLAG {0} \
   CONFIG.C_EN_LAST_WRITE_FLAG {0} \
   CONFIG.C_EN_RESPONSE_FLAG {0} \
   CONFIG.C_EN_WR_ADD_FLAG {0} \
   CONFIG.C_FIFO_AXIS_DEPTH {128} \
   CONFIG.C_REG_ALL_MONITOR_SIGNALS {0} \
   CONFIG.ENABLE_EXT_EVENTS {1} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.TSTRB_REMAP {3'b111,tstrb[0:0]} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_9_INTF_TYPE {xilinx.com:interface:aximm_rtl:1.0} \
 ] $system_ila_1
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {UART 1#UART 1#I2C 0#I2C 0###UART 0#UART 0###################PMU GPI 0#PMU GPI 1#PMU GPI 2#PMU GPI 3#PMU GPI 4#PMU GPI 5#PMU GPO 0#PMU GPO 1#PMU GPO 2#PMU GPO 3#PMU GPO 4#PMU GPO 5########################################} \
   CONFIG.PSU_MIO_TREE_SIGNALS {txd#rxd#scl_out#sda_out###rxd#txd###################gpi[0]#gpi[1]#gpi[2]#gpi[3]#gpi[4]#gpi[5]#gpo[0]#gpo[1]#gpo[2]#gpo[3]#gpo[4]#gpo[5]########################################} \
   ...
   CONFIG.PSU__CRL_APB__DLL_REF_CTRL__ACT_FREQMHZ {999.990} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_dma_2/M_AXI_SG] [get_bd_intf_pins smartconnect_1/S02_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_1] [get_bd_intf_pins axi_dma_2/M_AXI_SG] [get_bd_intf_pins system_ila_1/SLOT_6_AXI]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_1_M_AXI_S2MM] [get_bd_intf_pins axi_dma_1/M_AXI_S2MM] [get_bd_intf_pins system_ila_1/SLOT_11_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets axi_dma_1_M_AXI_S2MM]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_1_M_AXI_SG] [get_bd_intf_pins axi_dma_1/M_AXI_SG] [get_bd_intf_pins system_ila_1/SLOT_9_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets axi_dma_1_M_AXI_SG]
  connect_bd_intf_net -intf_net axi_dma_M_AXI_S2MM [get_bd_intf_pins axi_dma_2/M_AXI_S2MM] [get_bd_intf_pins smartconnect_2/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_M_AXI_S2MM] [get_bd_intf_pins axi_dma_2/M_AXI_S2MM] [get_bd_intf_pins system_ila_1/SLOT_10_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets axi_dma_M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_perf_mon_0_M_AXIS [get_bd_intf_pins axi_perf_mon_0/M_AXIS] [get_bd_intf_pins axis_subset_converter/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_perf_mon_0_M_AXIS] [get_bd_intf_pins axi_perf_mon_0/M_AXIS] [get_bd_intf_pins system_ila_1/SLOT_1_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets axi_perf_mon_0_M_AXIS]
  connect_bd_intf_net -intf_net axi_traffic_gen_0_M_AXIS_MASTER [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins axi_traffic_gen_0/M_AXIS_MASTER]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_traffic_gen_0_M_AXIS_MASTER] [get_bd_intf_pins axi_traffic_gen_0/M_AXIS_MASTER] [get_bd_intf_pins system_ila_1/SLOT_7_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets axi_traffic_gen_0_M_AXIS_MASTER]
  connect_bd_intf_net -intf_net axis_subset_converter_M_AXIS [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM] [get_bd_intf_pins axis_subset_converter/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_subset_converter_M_AXIS] [get_bd_intf_pins axis_subset_converter/M_AXIS] [get_bd_intf_pins system_ila_1/SLOT_5_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets axis_subset_converter_M_AXIS]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins axi_perf_mon_0/S_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M00_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins system_ila_1/SLOT_4_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets smartconnect_0_M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins axi_dma_2/S_AXI_LITE] [get_bd_intf_pins smartconnect_0/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M01_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI] [get_bd_intf_pins system_ila_1/SLOT_2_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets smartconnect_0_M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins smartconnect_0/M02_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M02_AXI] [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins system_ila_1/SLOT_8_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets smartconnect_0_M02_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins axi_traffic_gen_0/S_AXI] [get_bd_intf_pins smartconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins smartconnect_1/S01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins smartconnect_0/M05_AXI] [get_bd_intf_pins smartconnect_2/S02_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_1_M00_AXI] [get_bd_intf_pins smartconnect_1/M00_AXI] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_FPD] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM1_FPD] [get_bd_intf_pins system_ila_1/SLOT_3_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM1_FPD]

  # Create port connections
  connect_bd_net -net axi_perf_mon_0_interrupt [get_bd_pins axi_perf_mon_0/interrupt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net rst_ps8_0_96M_interconnect_aresetn [get_bd_pins axis_subset_converter/aresetn] [get_bd_pins rst_ps8_0_96M/interconnect_aresetn] [get_bd_pins smartconnect_2/aresetn]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/ext_rstn_0] [get_bd_pins axi_perf_mon_0/m_axis_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_traffic_gen_0/s_axi_aresetn] [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins system_ila_1/resetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins axi_traffic_gen_0/core_ext_start] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins axi_traffic_gen_0/core_ext_stop] [get_bd_pins vio_0/probe_out1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/m_axi_sg_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/m_axi_sg_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/ext_clk_0] [get_bd_pins axi_perf_mon_0/m_axis_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_traffic_gen_0/s_axi_aclk] [get_bd_pins axis_subset_converter/aclk] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_1/clk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0xB0020000 [get_bd_addr_spaces axi_dma_1/Data_SG] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0xB0030000 [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xB0020000 [get_bd_addr_spaces axi_dma_2/Data_SG] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0xB0030000 [get_bd_addr_spaces axi_dma_2/Data_S2MM] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00200000 -offset 0x000400000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00002000 -offset 0xB0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0xB0030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xB0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_1/S_AXI_LITE/Reg] SEG_axi_dma_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_2/S_AXI_LITE/Reg] SEG_axi_dma_2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x000500000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_perf_mon_0/S_AXI/Reg] SEG_axi_perf_mon_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_traffic_gen_0/S_AXI/Reg0] SEG_axi_traffic_gen_0_Reg0
