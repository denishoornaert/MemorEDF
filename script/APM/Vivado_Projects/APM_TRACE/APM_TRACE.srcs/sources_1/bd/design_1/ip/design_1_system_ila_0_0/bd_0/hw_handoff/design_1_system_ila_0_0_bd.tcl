...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXIS:SLOT_3_AXIS:SLOT_4_AXI:SLOT_5_AXI:SLOT_6_AXI:SLOT_7_AXI} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_2_AXIS_TDATA_WIDTH {56} \
   ...
   CONFIG.C_SLOT_3_AXIS_TDEST_WIDTH {8} \
   CONFIG.C_SLOT_3_AXIS_TID_WIDTH {8} \
   CONFIG.C_SLOT_3_AXIS_TUSER_WIDTH {8} \
   ...
   CONFIG.C_SLOT_5_AXI_ADDR_WIDTH {40} \
   CONFIG.C_SLOT_5_AXI_ARUSER_WIDTH {16} \
   CONFIG.C_SLOT_5_AXI_AR_SEL {1} \
   CONFIG.C_SLOT_5_AXI_AWUSER_WIDTH {16} \
   ...
   CONFIG.C_SLOT_5_AXI_DATA_WIDTH {128} \
   CONFIG.C_SLOT_5_AXI_ID_WIDTH {16} \
   ...
   CONFIG.C_SLOT_6_AXI_ADDR_WIDTH {10} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE133_WIDTH {10} \
   CONFIG.C_PROBE134_TYPE {0} \
   CONFIG.C_PROBE134_WIDTH {3} \
   ...
   CONFIG.C_PROBE153_WIDTH {49} \
   CONFIG.C_PROBE154_TYPE {0} \
   CONFIG.C_PROBE154_WIDTH {8} \
   CONFIG.C_PROBE155_TYPE {0} \
   CONFIG.C_PROBE155_WIDTH {3} \
   CONFIG.C_PROBE156_TYPE {0} \
   CONFIG.C_PROBE156_WIDTH {3} \
   ...
   CONFIG.C_PROBE161_WIDTH {32} \
   CONFIG.C_PROBE162_TYPE {0} \
   CONFIG.C_PROBE162_WIDTH {4} \
...
connect_bd_intf_net -intf_net Conn7 [get_bd_intf_ports SLOT_7_AXI] [get_bd_intf_pins g_inst/slot_7_axi]
  ...
  connect_bd_net -net net_slot_1_axi_aw_cnt [get_bd_pins g_inst/m_slot_1_axi_aw_cnt] [get_bd_pins ila_lib/probe39]
  connect_bd_net -net net_slot_1_axi_aw_ctrl [get_bd_pins ila_lib/probe49] [get_bd_pins slot_1_aw/dout]
  connect_bd_net -net net_slot_1_axi_awaddr [get_bd_pins g_inst/m_slot_1_axi_awaddr] [get_bd_pins ila_lib/probe40]
  connect_bd_net -net net_slot_1_axi_awprot [get_bd_pins g_inst/m_slot_1_axi_awprot] [get_bd_pins ila_lib/probe41]
  ...
  connect_bd_net -net net_slot_2_axis_tid [get_bd_pins g_inst/m_slot_2_axis_tid] [get_bd_pins ila_lib/probe55]
  connect_bd_net -net net_slot_2_axis_tlast [get_bd_pins g_inst/m_slot_2_axis_tlast] [get_bd_pins ila_lib/probe59]
  connect_bd_net -net net_slot_2_axis_tready [get_bd_pins g_inst/m_slot_2_axis_tready] [get_bd_pins ila_lib/probe58]
  connect_bd_net -net net_slot_2_axis_tstrb [get_bd_pins g_inst/m_slot_2_axis_tstrb] [get_bd_pins ila_lib/probe56]
  connect_bd_net -net net_slot_2_axis_tvalid [get_bd_pins g_inst/m_slot_2_axis_tvalid] [get_bd_pins ila_lib/probe57]
  connect_bd_net -net net_slot_3_axis_tdata [get_bd_pins g_inst/m_slot_3_axis_tdata] [get_bd_pins ila_lib/probe60]
  connect_bd_net -net net_slot_3_axis_tdest [get_bd_pins g_inst/m_slot_3_axis_tdest] [get_bd_pins ila_lib/probe61]
  connect_bd_net -net net_slot_3_axis_tid [get_bd_pins g_inst/m_slot_3_axis_tid] [get_bd_pins ila_lib/probe62]
  connect_bd_net -net net_slot_3_axis_tkeep [get_bd_pins g_inst/m_slot_3_axis_tkeep] [get_bd_pins ila_lib/probe63]
  connect_bd_net -net net_slot_3_axis_tlast [get_bd_pins g_inst/m_slot_3_axis_tlast] [get_bd_pins ila_lib/probe68]
  connect_bd_net -net net_slot_3_axis_tready [get_bd_pins g_inst/m_slot_3_axis_tready] [get_bd_pins ila_lib/probe67]
  connect_bd_net -net net_slot_3_axis_tstrb [get_bd_pins g_inst/m_slot_3_axis_tstrb] [get_bd_pins ila_lib/probe64]
  connect_bd_net -net net_slot_3_axis_tuser [get_bd_pins g_inst/m_slot_3_axis_tuser] [get_bd_pins ila_lib/probe65]
  connect_bd_net -net net_slot_3_axis_tvalid [get_bd_pins g_inst/m_slot_3_axis_tvalid] [get_bd_pins ila_lib/probe66]
  connect_bd_net -net net_slot_4_axi_ar_cnt [get_bd_pins g_inst/m_slot_4_axi_ar_cnt] [get_bd_pins ila_lib/probe69]
  connect_bd_net -net net_slot_4_axi_ar_ctrl [get_bd_pins ila_lib/probe91] [get_bd_pins slot_4_ar/dout]
  connect_bd_net -net net_slot_4_axi_araddr [get_bd_pins g_inst/m_slot_4_axi_araddr] [get_bd_pins ila_lib/probe70]
  connect_bd_net -net net_slot_4_axi_arcache [get_bd_pins g_inst/m_slot_4_axi_arcache] [get_bd_pins ila_lib/probe71]
  connect_bd_net -net net_slot_4_axi_arlen [get_bd_pins g_inst/m_slot_4_axi_arlen] [get_bd_pins ila_lib/probe72]
  connect_bd_net -net net_slot_4_axi_arprot [get_bd_pins g_inst/m_slot_4_axi_arprot] [get_bd_pins ila_lib/probe73]
  connect_bd_net -net net_slot_4_axi_arready [get_bd_pins g_inst/m_slot_4_axi_arready] [get_bd_pins slot_4_ar/In1]
  connect_bd_net -net net_slot_4_axi_arsize [get_bd_pins g_inst/m_slot_4_axi_arsize] [get_bd_pins ila_lib/probe74]
  connect_bd_net -net net_slot_4_axi_arvalid [get_bd_pins g_inst/m_slot_4_axi_arvalid] [get_bd_pins slot_4_ar/In0]
  connect_bd_net -net net_slot_4_axi_aw_cnt [get_bd_pins g_inst/m_slot_4_axi_aw_cnt] [get_bd_pins ila_lib/probe75]
  connect_bd_net -net net_slot_4_axi_aw_ctrl [get_bd_pins ila_lib/probe88] [get_bd_pins slot_4_aw/dout]
  connect_bd_net -net net_slot_4_axi_awaddr [get_bd_pins g_inst/m_slot_4_axi_awaddr] [get_bd_pins ila_lib/probe76]
  connect_bd_net -net net_slot_4_axi_awcache [get_bd_pins g_inst/m_slot_4_axi_awcache] [get_bd_pins ila_lib/probe77]
  connect_bd_net -net net_slot_4_axi_awlen [get_bd_pins g_inst/m_slot_4_axi_awlen] [get_bd_pins ila_lib/probe78]
  connect_bd_net -net net_slot_4_axi_awprot [get_bd_pins g_inst/m_slot_4_axi_awprot] [get_bd_pins ila_lib/probe79]
  connect_bd_net -net net_slot_4_axi_awready [get_bd_pins g_inst/m_slot_4_axi_awready] [get_bd_pins slot_4_aw/In1]
  connect_bd_net -net net_slot_4_axi_awsize [get_bd_pins g_inst/m_slot_4_axi_awsize] [get_bd_pins ila_lib/probe80]
  connect_bd_net -net net_slot_4_axi_awvalid [get_bd_pins g_inst/m_slot_4_axi_awvalid] [get_bd_pins slot_4_aw/In0]
  connect_bd_net -net net_slot_4_axi_b_cnt [get_bd_pins g_inst/m_slot_4_axi_b_cnt] [get_bd_pins ila_lib/probe81]
  connect_bd_net -net net_slot_4_axi_b_ctrl [get_bd_pins ila_lib/probe90] [get_bd_pins slot_4_b/dout]
  connect_bd_net -net net_slot_4_axi_bready [get_bd_pins g_inst/m_slot_4_axi_bready] [get_bd_pins slot_4_b/In1]
  connect_bd_net -net net_slot_4_axi_bresp [get_bd_pins g_inst/m_slot_4_axi_bresp] [get_bd_pins ila_lib/probe82]
  connect_bd_net -net net_slot_4_axi_bvalid [get_bd_pins g_inst/m_slot_4_axi_bvalid] [get_bd_pins slot_4_b/In0]
  connect_bd_net -net net_slot_4_axi_r_cnt [get_bd_pins g_inst/m_slot_4_axi_r_cnt] [get_bd_pins ila_lib/probe83]
  connect_bd_net -net net_slot_4_axi_r_ctrl [get_bd_pins ila_lib/probe92] [get_bd_pins slot_4_r/dout]
  connect_bd_net -net net_slot_4_axi_rdata [get_bd_pins g_inst/m_slot_4_axi_rdata] [get_bd_pins ila_lib/probe84]
  ...
  connect_bd_net -net net_slot_4_axi_rresp [get_bd_pins g_inst/m_slot_4_axi_rresp] [get_bd_pins ila_lib/probe85]
  connect_bd_net -net net_slot_4_axi_rvalid [get_bd_pins g_inst/m_slot_4_axi_rvalid] [get_bd_pins slot_4_r/In0]
  connect_bd_net -net net_slot_4_axi_w_ctrl [get_bd_pins ila_lib/probe89] [get_bd_pins slot_4_w/dout]
  connect_bd_net -net net_slot_4_axi_wdata [get_bd_pins g_inst/m_slot_4_axi_wdata] [get_bd_pins ila_lib/probe86]
  ...
  connect_bd_net -net net_slot_4_axi_wstrb [get_bd_pins g_inst/m_slot_4_axi_wstrb] [get_bd_pins ila_lib/probe87]
  connect_bd_net -net net_slot_4_axi_wvalid [get_bd_pins g_inst/m_slot_4_axi_wvalid] [get_bd_pins slot_4_w/In0]
  connect_bd_net -net net_slot_5_axi_ar_cnt [get_bd_pins g_inst/m_slot_5_axi_ar_cnt] [get_bd_pins ila_lib/probe93]
  connect_bd_net -net net_slot_5_axi_ar_ctrl [get_bd_pins ila_lib/probe127] [get_bd_pins slot_5_ar/dout]
  connect_bd_net -net net_slot_5_axi_araddr [get_bd_pins g_inst/m_slot_5_axi_araddr] [get_bd_pins ila_lib/probe94]
  connect_bd_net -net net_slot_5_axi_arburst [get_bd_pins g_inst/m_slot_5_axi_arburst] [get_bd_pins ila_lib/probe95]
  connect_bd_net -net net_slot_5_axi_arcache [get_bd_pins g_inst/m_slot_5_axi_arcache] [get_bd_pins ila_lib/probe96]
  connect_bd_net -net net_slot_5_axi_arid [get_bd_pins g_inst/m_slot_5_axi_arid] [get_bd_pins ila_lib/probe97]
  connect_bd_net -net net_slot_5_axi_arlen [get_bd_pins g_inst/m_slot_5_axi_arlen] [get_bd_pins ila_lib/probe98]
  connect_bd_net -net net_slot_5_axi_arlock [get_bd_pins g_inst/m_slot_5_axi_arlock] [get_bd_pins ila_lib/probe99]
  connect_bd_net -net net_slot_5_axi_arprot [get_bd_pins g_inst/m_slot_5_axi_arprot] [get_bd_pins ila_lib/probe100]
  connect_bd_net -net net_slot_5_axi_arqos [get_bd_pins g_inst/m_slot_5_axi_arqos] [get_bd_pins ila_lib/probe101]
  connect_bd_net -net net_slot_5_axi_arready [get_bd_pins g_inst/m_slot_5_axi_arready] [get_bd_pins slot_5_ar/In1]
  connect_bd_net -net net_slot_5_axi_arsize [get_bd_pins g_inst/m_slot_5_axi_arsize] [get_bd_pins ila_lib/probe102]
  connect_bd_net -net net_slot_5_axi_aruser [get_bd_pins g_inst/m_slot_5_axi_aruser] [get_bd_pins ila_lib/probe103]
  connect_bd_net -net net_slot_5_axi_arvalid [get_bd_pins g_inst/m_slot_5_axi_arvalid] [get_bd_pins slot_5_ar/In0]
  connect_bd_net -net net_slot_5_axi_aw_cnt [get_bd_pins g_inst/m_slot_5_axi_aw_cnt] [get_bd_pins ila_lib/probe104]
  connect_bd_net -net net_slot_5_axi_aw_ctrl [get_bd_pins ila_lib/probe124] [get_bd_pins slot_5_aw/dout]
  connect_bd_net -net net_slot_5_axi_awaddr [get_bd_pins g_inst/m_slot_5_axi_awaddr] [get_bd_pins ila_lib/probe105]
  connect_bd_net -net net_slot_5_axi_awburst [get_bd_pins g_inst/m_slot_5_axi_awburst] [get_bd_pins ila_lib/probe106]
  connect_bd_net -net net_slot_5_axi_awcache [get_bd_pins g_inst/m_slot_5_axi_awcache] [get_bd_pins ila_lib/probe107]
  connect_bd_net -net net_slot_5_axi_awid [get_bd_pins g_inst/m_slot_5_axi_awid] [get_bd_pins ila_lib/probe108]
  connect_bd_net -net net_slot_5_axi_awlen [get_bd_pins g_inst/m_slot_5_axi_awlen] [get_bd_pins ila_lib/probe109]
  connect_bd_net -net net_slot_5_axi_awlock [get_bd_pins g_inst/m_slot_5_axi_awlock] [get_bd_pins ila_lib/probe110]
  connect_bd_net -net net_slot_5_axi_awprot [get_bd_pins g_inst/m_slot_5_axi_awprot] [get_bd_pins ila_lib/probe111]
  connect_bd_net -net net_slot_5_axi_awqos [get_bd_pins g_inst/m_slot_5_axi_awqos] [get_bd_pins ila_lib/probe112]
  connect_bd_net -net net_slot_5_axi_awready [get_bd_pins g_inst/m_slot_5_axi_awready] [get_bd_pins slot_5_aw/In1]
  connect_bd_net -net net_slot_5_axi_awsize [get_bd_pins g_inst/m_slot_5_axi_awsize] [get_bd_pins ila_lib/probe113]
  connect_bd_net -net net_slot_5_axi_awuser [get_bd_pins g_inst/m_slot_5_axi_awuser] [get_bd_pins ila_lib/probe114]
  connect_bd_net -net net_slot_5_axi_awvalid [get_bd_pins g_inst/m_slot_5_axi_awvalid] [get_bd_pins slot_5_aw/In0]
  connect_bd_net -net net_slot_5_axi_b_cnt [get_bd_pins g_inst/m_slot_5_axi_b_cnt] [get_bd_pins ila_lib/probe115]
  connect_bd_net -net net_slot_5_axi_b_ctrl [get_bd_pins ila_lib/probe126] [get_bd_pins slot_5_b/dout]
  connect_bd_net -net net_slot_5_axi_bid [get_bd_pins g_inst/m_slot_5_axi_bid] [get_bd_pins ila_lib/probe116]
  connect_bd_net -net net_slot_5_axi_bready [get_bd_pins g_inst/m_slot_5_axi_bready] [get_bd_pins slot_5_b/In1]
  connect_bd_net -net net_slot_5_axi_bresp [get_bd_pins g_inst/m_slot_5_axi_bresp] [get_bd_pins ila_lib/probe117]
  connect_bd_net -net net_slot_5_axi_bvalid [get_bd_pins g_inst/m_slot_5_axi_bvalid] [get_bd_pins slot_5_b/In0]
  connect_bd_net -net net_slot_5_axi_r_cnt [get_bd_pins g_inst/m_slot_5_axi_r_cnt] [get_bd_pins ila_lib/probe118]
  connect_bd_net -net net_slot_5_axi_r_ctrl [get_bd_pins ila_lib/probe128] [get_bd_pins slot_5_r/dout]
  connect_bd_net -net net_slot_5_axi_rdata [get_bd_pins g_inst/m_slot_5_axi_rdata] [get_bd_pins ila_lib/probe119]
  connect_bd_net -net net_slot_5_axi_rid [get_bd_pins g_inst/m_slot_5_axi_rid] [get_bd_pins ila_lib/probe120]
  ...
  connect_bd_net -net net_slot_5_axi_rresp [get_bd_pins g_inst/m_slot_5_axi_rresp] [get_bd_pins ila_lib/probe121]
  connect_bd_net -net net_slot_5_axi_rvalid [get_bd_pins g_inst/m_slot_5_axi_rvalid] [get_bd_pins slot_5_r/In0]
  connect_bd_net -net net_slot_5_axi_w_ctrl [get_bd_pins ila_lib/probe125] [get_bd_pins slot_5_w/dout]
  connect_bd_net -net net_slot_5_axi_wdata [get_bd_pins g_inst/m_slot_5_axi_wdata] [get_bd_pins ila_lib/probe122]
  ...
  connect_bd_net -net net_slot_5_axi_wstrb [get_bd_pins g_inst/m_slot_5_axi_wstrb] [get_bd_pins ila_lib/probe123]
  connect_bd_net -net net_slot_5_axi_wvalid [get_bd_pins g_inst/m_slot_5_axi_wvalid] [get_bd_pins slot_5_w/In0]
  connect_bd_net -net net_slot_6_axi_ar_cnt [get_bd_pins g_inst/m_slot_6_axi_ar_cnt] [get_bd_pins ila_lib/probe129]
  connect_bd_net -net net_slot_6_axi_ar_ctrl [get_bd_pins ila_lib/probe145] [get_bd_pins slot_6_ar/dout]
  connect_bd_net -net net_slot_6_axi_araddr [get_bd_pins g_inst/m_slot_6_axi_araddr] [get_bd_pins ila_lib/probe130]
  connect_bd_net -net net_slot_6_axi_arprot [get_bd_pins g_inst/m_slot_6_axi_arprot] [get_bd_pins ila_lib/probe131]
  ...
  connect_bd_net -net net_slot_6_axi_aw_cnt [get_bd_pins g_inst/m_slot_6_axi_aw_cnt] [get_bd_pins ila_lib/probe132]
  connect_bd_net -net net_slot_6_axi_aw_ctrl [get_bd_pins ila_lib/probe142] [get_bd_pins slot_6_aw/dout]
  connect_bd_net -net net_slot_6_axi_awaddr [get_bd_pins g_inst/m_slot_6_axi_awaddr] [get_bd_pins ila_lib/probe133]
  connect_bd_net -net net_slot_6_axi_awprot [get_bd_pins g_inst/m_slot_6_axi_awprot] [get_bd_pins ila_lib/probe134]
  ...
  connect_bd_net -net net_slot_6_axi_b_cnt [get_bd_pins g_inst/m_slot_6_axi_b_cnt] [get_bd_pins ila_lib/probe135]
  connect_bd_net -net net_slot_6_axi_b_ctrl [get_bd_pins ila_lib/probe144] [get_bd_pins slot_6_b/dout]
  connect_bd_net -net net_slot_6_axi_bready [get_bd_pins g_inst/m_slot_6_axi_bready] [get_bd_pins slot_6_b/In1]
  connect_bd_net -net net_slot_6_axi_bresp [get_bd_pins g_inst/m_slot_6_axi_bresp] [get_bd_pins ila_lib/probe136]
  connect_bd_net -net net_slot_6_axi_bvalid [get_bd_pins g_inst/m_slot_6_axi_bvalid] [get_bd_pins slot_6_b/In0]
  connect_bd_net -net net_slot_6_axi_r_cnt [get_bd_pins g_inst/m_slot_6_axi_r_cnt] [get_bd_pins ila_lib/probe137]
  connect_bd_net -net net_slot_6_axi_r_ctrl [get_bd_pins ila_lib/probe146] [get_bd_pins slot_6_r/dout]
  connect_bd_net -net net_slot_6_axi_rdata [get_bd_pins g_inst/m_slot_6_axi_rdata] [get_bd_pins ila_lib/probe138]
  connect_bd_net -net net_slot_6_axi_rready [get_bd_pins g_inst/m_slot_6_axi_rready] [get_bd_pins slot_6_r/In1]
  connect_bd_net -net net_slot_6_axi_rresp [get_bd_pins g_inst/m_slot_6_axi_rresp] [get_bd_pins ila_lib/probe139]
  connect_bd_net -net net_slot_6_axi_rvalid [get_bd_pins g_inst/m_slot_6_axi_rvalid] [get_bd_pins slot_6_r/In0]
  connect_bd_net -net net_slot_6_axi_w_ctrl [get_bd_pins ila_lib/probe143] [get_bd_pins slot_6_w/dout]
  connect_bd_net -net net_slot_6_axi_wdata [get_bd_pins g_inst/m_slot_6_axi_wdata] [get_bd_pins ila_lib/probe140]
  connect_bd_net -net net_slot_6_axi_wready [get_bd_pins g_inst/m_slot_6_axi_wready] [get_bd_pins slot_6_w/In1]
  connect_bd_net -net net_slot_6_axi_wstrb [get_bd_pins g_inst/m_slot_6_axi_wstrb] [get_bd_pins ila_lib/probe141]
  connect_bd_net -net net_slot_6_axi_wvalid [get_bd_pins g_inst/m_slot_6_axi_wvalid] [get_bd_pins slot_6_w/In0]
  connect_bd_net -net net_slot_7_axi_ar_cnt [get_bd_pins g_inst/m_slot_7_axi_ar_cnt] [get_bd_pins ila_lib/probe147]
  connect_bd_net -net net_slot_7_axi_ar_ctrl [get_bd_pins ila_lib/probe166] [get_bd_pins slot_7_ar/dout]
  connect_bd_net -net net_slot_7_axi_araddr [get_bd_pins g_inst/m_slot_7_axi_araddr] [get_bd_pins ila_lib/probe148]
  connect_bd_net -net net_slot_7_axi_arlen [get_bd_pins g_inst/m_slot_7_axi_arlen] [get_bd_pins ila_lib/probe149]
  connect_bd_net -net net_slot_7_axi_arprot [get_bd_pins g_inst/m_slot_7_axi_arprot] [get_bd_pins ila_lib/probe150]
  connect_bd_net -net net_slot_7_axi_arready [get_bd_pins g_inst/m_slot_7_axi_arready] [get_bd_pins slot_7_ar/In1]
  connect_bd_net -net net_slot_7_axi_arsize [get_bd_pins g_inst/m_slot_7_axi_arsize] [get_bd_pins ila_lib/probe151]
  connect_bd_net -net net_slot_7_axi_arvalid [get_bd_pins g_inst/m_slot_7_axi_arvalid] [get_bd_pins slot_7_ar/In0]
  connect_bd_net -net net_slot_7_axi_aw_cnt [get_bd_pins g_inst/m_slot_7_axi_aw_cnt] [get_bd_pins ila_lib/probe152]
  connect_bd_net -net net_slot_7_axi_aw_ctrl [get_bd_pins ila_lib/probe163] [get_bd_pins slot_7_aw/dout]
  connect_bd_net -net net_slot_7_axi_awaddr [get_bd_pins g_inst/m_slot_7_axi_awaddr] [get_bd_pins ila_lib/probe153]
  connect_bd_net -net net_slot_7_axi_awlen [get_bd_pins g_inst/m_slot_7_axi_awlen] [get_bd_pins ila_lib/probe154]
  connect_bd_net -net net_slot_7_axi_awprot [get_bd_pins g_inst/m_slot_7_axi_awprot] [get_bd_pins ila_lib/probe155]
  connect_bd_net -net net_slot_7_axi_awready [get_bd_pins g_inst/m_slot_7_axi_awready] [get_bd_pins slot_7_aw/In1]
  connect_bd_net -net net_slot_7_axi_awsize [get_bd_pins g_inst/m_slot_7_axi_awsize] [get_bd_pins ila_lib/probe156]
  connect_bd_net -net net_slot_7_axi_awvalid [get_bd_pins g_inst/m_slot_7_axi_awvalid] [get_bd_pins slot_7_aw/In0]
  connect_bd_net -net net_slot_7_axi_b_cnt [get_bd_pins g_inst/m_slot_7_axi_b_cnt] [get_bd_pins ila_lib/probe157]
  connect_bd_net -net net_slot_7_axi_b_ctrl [get_bd_pins ila_lib/probe165] [get_bd_pins slot_7_b/dout]
  connect_bd_net -net net_slot_7_axi_bready [get_bd_pins g_inst/m_slot_7_axi_bready] [get_bd_pins slot_7_b/In1]
  connect_bd_net -net net_slot_7_axi_bresp [get_bd_pins g_inst/m_slot_7_axi_bresp] [get_bd_pins ila_lib/probe158]
  connect_bd_net -net net_slot_7_axi_bvalid [get_bd_pins g_inst/m_slot_7_axi_bvalid] [get_bd_pins slot_7_b/In0]
  connect_bd_net -net net_slot_7_axi_r_cnt [get_bd_pins g_inst/m_slot_7_axi_r_cnt] [get_bd_pins ila_lib/probe159]
  connect_bd_net -net net_slot_7_axi_r_ctrl [get_bd_pins ila_lib/probe167] [get_bd_pins slot_7_r/dout]
  connect_bd_net -net net_slot_7_axi_rdata [get_bd_pins g_inst/m_slot_7_axi_rdata] [get_bd_pins ila_lib/probe160]
  ...
  connect_bd_net -net net_slot_7_axi_w_ctrl [get_bd_pins ila_lib/probe164] [get_bd_pins slot_7_w/dout]
  connect_bd_net -net net_slot_7_axi_wdata [get_bd_pins g_inst/m_slot_7_axi_wdata] [get_bd_pins ila_lib/probe161]
  ...
  connect_bd_net -net net_slot_7_axi_wstrb [get_bd_pins g_inst/m_slot_7_axi_wstrb] [get_bd_pins ila_lib/probe162]
