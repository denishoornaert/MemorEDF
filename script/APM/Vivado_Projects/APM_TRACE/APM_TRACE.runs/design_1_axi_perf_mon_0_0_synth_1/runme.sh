...
HD_PWD='/home/renato/MemorEDF_old/Vivado_Projects/APM_TRACE/APM_TRACE.runs/design_1_axi_perf_mon_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_perf_mon_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_perf_mon_0_0.tcl
