...
theuser=renato
user=$(id -u)
loc=/home/$theuser/MemorEDF_old/lnx_jailhouse
...
petalinux-package --boot --fsbl build/tmp/deploy/images/plnx_aarch64/fsbl-plnx_aarch64.elf --fpga ../HDF_FPGAREADY/MEDF.bit --pmufw build/tmp/deploy/images/plnx_aarch64/pmu-plnx_aarch64.elf --u-boot build/tmp/deploy/images/plnx_aarch64/u-boot.elf --force
