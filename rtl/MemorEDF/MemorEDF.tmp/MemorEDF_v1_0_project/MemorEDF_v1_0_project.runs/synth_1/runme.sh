...
HD_PWD='/home/duck/Github/MemorEDF/rtl/MemorEDF/MemorEDF.tmp/MemorEDF_v1_0_project/MemorEDF_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemorEDF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemorEDF.tcl
