...
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_ports SLOT_3_AXI] [get_bd_intf_pins g_inst/slot_3_axi]
  ...
  connect_bd_net -net net_slot_2_axi_ar_ctrl [get_bd_pins ila_lib/probe106] [get_bd_pins slot_2_ar/dout]
  connect_bd_net -net net_slot_2_axi_araddr [get_bd_pins g_inst/m_slot_2_axi_araddr] [get_bd_pins ila_lib/probe73]
  connect_bd_net -net net_slot_2_axi_arburst [get_bd_pins g_inst/m_slot_2_axi_arburst] [get_bd_pins ila_lib/probe74]
  connect_bd_net -net net_slot_2_axi_arcache [get_bd_pins g_inst/m_slot_2_axi_arcache] [get_bd_pins ila_lib/probe75]
  connect_bd_net -net net_slot_2_axi_arid [get_bd_pins g_inst/m_slot_2_axi_arid] [get_bd_pins ila_lib/probe76]
  connect_bd_net -net net_slot_2_axi_arlen [get_bd_pins g_inst/m_slot_2_axi_arlen] [get_bd_pins ila_lib/probe77]
  connect_bd_net -net net_slot_2_axi_arlock [get_bd_pins g_inst/m_slot_2_axi_arlock] [get_bd_pins ila_lib/probe78]
  connect_bd_net -net net_slot_2_axi_arprot [get_bd_pins g_inst/m_slot_2_axi_arprot] [get_bd_pins ila_lib/probe79]
  connect_bd_net -net net_slot_2_axi_arqos [get_bd_pins g_inst/m_slot_2_axi_arqos] [get_bd_pins ila_lib/probe80]
  connect_bd_net -net net_slot_2_axi_arready [get_bd_pins g_inst/m_slot_2_axi_arready] [get_bd_pins slot_2_ar/In1]
  connect_bd_net -net net_slot_2_axi_arsize [get_bd_pins g_inst/m_slot_2_axi_arsize] [get_bd_pins ila_lib/probe81]
  connect_bd_net -net net_slot_2_axi_aruser [get_bd_pins g_inst/m_slot_2_axi_aruser] [get_bd_pins ila_lib/probe82]
  connect_bd_net -net net_slot_2_axi_arvalid [get_bd_pins g_inst/m_slot_2_axi_arvalid] [get_bd_pins slot_2_ar/In0]
  connect_bd_net -net net_slot_2_axi_aw_cnt [get_bd_pins g_inst/m_slot_2_axi_aw_cnt] [get_bd_pins ila_lib/probe83]
  connect_bd_net -net net_slot_2_axi_aw_ctrl [get_bd_pins ila_lib/probe103] [get_bd_pins slot_2_aw/dout]
  connect_bd_net -net net_slot_2_axi_awaddr [get_bd_pins g_inst/m_slot_2_axi_awaddr] [get_bd_pins ila_lib/probe84]
  connect_bd_net -net net_slot_2_axi_awburst [get_bd_pins g_inst/m_slot_2_axi_awburst] [get_bd_pins ila_lib/probe85]
  connect_bd_net -net net_slot_2_axi_awcache [get_bd_pins g_inst/m_slot_2_axi_awcache] [get_bd_pins ila_lib/probe86]
  connect_bd_net -net net_slot_2_axi_awid [get_bd_pins g_inst/m_slot_2_axi_awid] [get_bd_pins ila_lib/probe87]
  connect_bd_net -net net_slot_2_axi_awlen [get_bd_pins g_inst/m_slot_2_axi_awlen] [get_bd_pins ila_lib/probe88]
  connect_bd_net -net net_slot_2_axi_awlock [get_bd_pins g_inst/m_slot_2_axi_awlock] [get_bd_pins ila_lib/probe89]
  connect_bd_net -net net_slot_2_axi_awprot [get_bd_pins g_inst/m_slot_2_axi_awprot] [get_bd_pins ila_lib/probe90]
  connect_bd_net -net net_slot_2_axi_awqos [get_bd_pins g_inst/m_slot_2_axi_awqos] [get_bd_pins ila_lib/probe91]
  connect_bd_net -net net_slot_2_axi_awready [get_bd_pins g_inst/m_slot_2_axi_awready] [get_bd_pins slot_2_aw/In1]
  connect_bd_net -net net_slot_2_axi_awsize [get_bd_pins g_inst/m_slot_2_axi_awsize] [get_bd_pins ila_lib/probe92]
  connect_bd_net -net net_slot_2_axi_awuser [get_bd_pins g_inst/m_slot_2_axi_awuser] [get_bd_pins ila_lib/probe93]
  connect_bd_net -net net_slot_2_axi_awvalid [get_bd_pins g_inst/m_slot_2_axi_awvalid] [get_bd_pins slot_2_aw/In0]
  connect_bd_net -net net_slot_2_axi_b_cnt [get_bd_pins g_inst/m_slot_2_axi_b_cnt] [get_bd_pins ila_lib/probe94]
  connect_bd_net -net net_slot_2_axi_b_ctrl [get_bd_pins ila_lib/probe105] [get_bd_pins slot_2_b/dout]
  connect_bd_net -net net_slot_2_axi_bid [get_bd_pins g_inst/m_slot_2_axi_bid] [get_bd_pins ila_lib/probe95]
  connect_bd_net -net net_slot_2_axi_bready [get_bd_pins g_inst/m_slot_2_axi_bready] [get_bd_pins slot_2_b/In1]
  connect_bd_net -net net_slot_2_axi_bresp [get_bd_pins g_inst/m_slot_2_axi_bresp] [get_bd_pins ila_lib/probe96]
  connect_bd_net -net net_slot_2_axi_bvalid [get_bd_pins g_inst/m_slot_2_axi_bvalid] [get_bd_pins slot_2_b/In0]
  connect_bd_net -net net_slot_2_axi_r_cnt [get_bd_pins g_inst/m_slot_2_axi_r_cnt] [get_bd_pins ila_lib/probe97]
  connect_bd_net -net net_slot_2_axi_r_ctrl [get_bd_pins ila_lib/probe107] [get_bd_pins slot_2_r/dout]
  connect_bd_net -net net_slot_2_axi_rdata [get_bd_pins g_inst/m_slot_2_axi_rdata] [get_bd_pins ila_lib/probe98]
  connect_bd_net -net net_slot_2_axi_rid [get_bd_pins g_inst/m_slot_2_axi_rid] [get_bd_pins ila_lib/probe99]
  ...
  connect_bd_net -net net_slot_2_axi_rresp [get_bd_pins g_inst/m_slot_2_axi_rresp] [get_bd_pins ila_lib/probe100]
  connect_bd_net -net net_slot_2_axi_rvalid [get_bd_pins g_inst/m_slot_2_axi_rvalid] [get_bd_pins slot_2_r/In0]
  connect_bd_net -net net_slot_2_axi_w_ctrl [get_bd_pins ila_lib/probe104] [get_bd_pins slot_2_w/dout]
  connect_bd_net -net net_slot_2_axi_wdata [get_bd_pins g_inst/m_slot_2_axi_wdata] [get_bd_pins ila_lib/probe101]
