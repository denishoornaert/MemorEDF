...
module bd_074c
  ...
  bd_074c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe100(net_slot_2_axi_r_cnt),
        .probe101(net_slot_2_axi_rdata),
        .probe102(net_slot_2_axi_rid),
        .probe103(net_slot_2_axi_rresp),
        .probe104(net_slot_2_axi_wdata),
        .probe105(net_slot_2_axi_wstrb),
        .probe106(net_slot_2_axi_aw_ctrl),
        .probe107(net_slot_2_axi_w_ctrl),
        .probe108(net_slot_2_axi_b_ctrl),
        .probe109(net_slot_2_axi_ar_ctrl),
        .probe11(net_slot_0_axi_aw_cnt),
        .probe110(net_slot_2_axi_r_ctrl),
        .probe111(net_slot_3_axi_ar_cnt),
        .probe112(net_slot_3_axi_araddr),
        .probe113(net_slot_3_axi_arburst),
        .probe114(net_slot_3_axi_arcache),
        .probe115(net_slot_3_axi_arid),
        .probe116(net_slot_3_axi_arlen),
        .probe117(net_slot_3_axi_arlock),
        .probe118(net_slot_3_axi_arprot),
        .probe119(net_slot_3_axi_arqos),
        .probe12(net_slot_0_axi_awaddr),
        .probe120(net_slot_3_axi_arsize),
        .probe121(net_slot_3_axi_aruser),
        .probe122(net_slot_3_axi_aw_cnt),
        .probe123(net_slot_3_axi_awaddr),
        .probe124(net_slot_3_axi_awburst),
        .probe125(net_slot_3_axi_awcache),
        .probe126(net_slot_3_axi_awid),
        .probe127(net_slot_3_axi_awlen),
        .probe128(net_slot_3_axi_awlock),
        .probe129(net_slot_3_axi_awprot),
        .probe13(net_slot_0_axi_awburst),
        .probe130(net_slot_3_axi_awqos),
        .probe131(net_slot_3_axi_awsize),
        .probe132(net_slot_3_axi_awuser),
        .probe133(net_slot_3_axi_b_cnt),
        .probe134(net_slot_3_axi_bid),
        .probe135(net_slot_3_axi_bresp),
        .probe136(net_slot_3_axi_buser),
        .probe137(net_slot_3_axi_r_cnt),
        .probe138(net_slot_3_axi_rdata),
        .probe139(net_slot_3_axi_rid),
        .probe14(net_slot_0_axi_awcache),
        .probe140(net_slot_3_axi_rresp),
        .probe141(net_slot_3_axi_ruser),
        .probe142(net_slot_3_axi_wdata),
        .probe143(net_slot_3_axi_wstrb),
        .probe144(net_slot_3_axi_wuser),
        .probe145(net_slot_3_axi_aw_ctrl),
        .probe146(net_slot_3_axi_w_ctrl),
        .probe147(net_slot_3_axi_b_ctrl),
        .probe148(net_slot_3_axi_ar_ctrl),
        .probe149(net_slot_3_axi_r_ctrl),
        .probe15(net_slot_0_axi_awid),
        .probe150(net_slot_4_axi_ar_cnt),
        .probe151(net_slot_4_axi_araddr),
        .probe152(net_slot_4_axi_arburst),
        .probe153(net_slot_4_axi_arcache),
        .probe154(net_slot_4_axi_arid),
        .probe155(net_slot_4_axi_arlen),
        .probe156(net_slot_4_axi_arlock),
        .probe157(net_slot_4_axi_arprot),
        .probe158(net_slot_4_axi_arqos),
        .probe159(net_slot_4_axi_arsize),
        .probe16(net_slot_0_axi_awlen),
        .probe160(net_slot_4_axi_aruser),
        .probe161(net_slot_4_axi_aw_cnt),
        .probe162(net_slot_4_axi_awaddr),
        .probe163(net_slot_4_axi_awburst),
        .probe164(net_slot_4_axi_awcache),
        .probe165(net_slot_4_axi_awid),
        .probe166(net_slot_4_axi_awlen),
        .probe167(net_slot_4_axi_awlock),
        .probe168(net_slot_4_axi_awprot),
        .probe169(net_slot_4_axi_awqos),
        .probe17(net_slot_0_axi_awlock),
        .probe170(net_slot_4_axi_awsize),
        .probe171(net_slot_4_axi_awuser),
        .probe172(net_slot_4_axi_b_cnt),
        .probe173(net_slot_4_axi_bid),
        .probe174(net_slot_4_axi_bresp),
        .probe175(net_slot_4_axi_r_cnt),
        .probe176(net_slot_4_axi_rdata),
        .probe177(net_slot_4_axi_rid),
        .probe178(net_slot_4_axi_rresp),
        .probe179(net_slot_4_axi_wdata),
        .probe18(net_slot_0_axi_awprot),
        .probe180(net_slot_4_axi_wstrb),
        .probe181(net_slot_4_axi_aw_ctrl),
        .probe182(net_slot_4_axi_w_ctrl),
        .probe183(net_slot_4_axi_b_ctrl),
        .probe184(net_slot_4_axi_ar_ctrl),
        .probe185(net_slot_4_axi_r_ctrl),
        ...
        .probe79(net_slot_2_axi_arid),
        .probe8(net_slot_0_axi_arqos),
        .probe80(net_slot_2_axi_arlen),
        .probe81(net_slot_2_axi_arlock),
        .probe82(net_slot_2_axi_arprot),
        .probe83(net_slot_2_axi_arqos),
        .probe84(net_slot_2_axi_arsize),
        .probe85(net_slot_2_axi_aruser),
        .probe86(net_slot_2_axi_aw_cnt),
        .probe87(net_slot_2_axi_awaddr),
        .probe88(net_slot_2_axi_awburst),
        .probe89(net_slot_2_axi_awcache),
        .probe9(net_slot_0_axi_arsize),
        .probe90(net_slot_2_axi_awid),
        .probe91(net_slot_2_axi_awlen),
        .probe92(net_slot_2_axi_awlock),
        .probe93(net_slot_2_axi_awprot),
        .probe94(net_slot_2_axi_awqos),
        .probe95(net_slot_2_axi_awsize),
        .probe96(net_slot_2_axi_awuser),
        .probe97(net_slot_2_axi_b_cnt),
        .probe98(net_slot_2_axi_bid),
        .probe99(net_slot_2_axi_bresp));
