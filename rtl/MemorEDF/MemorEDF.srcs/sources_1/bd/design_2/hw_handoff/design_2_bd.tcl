...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net MemorEDF_0_m00_axi [get_bd_intf_pins MemorEDF_0/m00_axi] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets MemorEDF_0_m00_axi] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  set_property -dict [ list \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins MemorEDF_0/m00_axi_aresetn] [get_bd_pins MemorEDF_0/s00_axi_aresetn] [get_bd_pins MemorEDF_0/s01_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins MemorEDF_0/m00_axi_aclk] [get_bd_pins MemorEDF_0/s00_axi_aclk] [get_bd_pins MemorEDF_0/s01_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces MemorEDF_0/m00_axi] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  ...
  create_bd_addr_seg -range 0x00200000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MemorEDF_0/s00_axi/reg0] SEG_MemorEDF_0_reg0
