...
`timescale 1 ns / 1 ps
	...
	(
		...
		parameter C_M00_AXI_ID_WIDTH     = 16,
...
//            input wire    [C_M00_AXI_BUSER_WIDTH-1 : 0] m00_axi_buser,
        ...
        assign write_new_msb         = {4'h0, write_isolated_bank, write_removed_msb};
        
        assign read_isolated_bank   = s00_axi_araddr[35 : 35];
        assign read_removed_msb     = s00_axi_araddr[34 : 0];
        assign read_new_msb         = {4'h0, read_isolated_bank, read_removed_msb};
