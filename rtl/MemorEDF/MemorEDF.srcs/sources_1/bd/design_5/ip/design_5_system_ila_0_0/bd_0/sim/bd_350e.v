...
//--------------------------------------------------------------------------------
//Command: generate_target bd_350e.bd
//Design : bd_350e
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_350e,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_350e,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=27,numReposBlks=27,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_5_system_ila_0_0.hwdef" *) 
module bd_350e
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
    ...
    clk,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 49, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 0, CLK_DOMAIN design_5_zynq_ultra_ps_e_0_0_pl_clk0, DATA_WIDTH 128, FREQ_HZ 99990000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [48:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_3_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_3_AXI, ADDR_WIDTH 40, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 0, CLK_DOMAIN design_5_zynq_ultra_ps_e_0_0_pl_clk0, DATA_WIDTH 128, FREQ_HZ 99990000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 16, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [39:0]SLOT_3_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_4_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_4_AXI, ADDR_WIDTH 40, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 0, CLK_DOMAIN design_5_zynq_ultra_ps_e_0_0_pl_clk0, DATA_WIDTH 128, FREQ_HZ 99990000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 16, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [39:0]SLOT_4_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_4_AXI ARUSER" *) input [0:0]SLOT_4_AXI_aruser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_4_AXI AWUSER" *) input [0:0]SLOT_4_AXI_awuser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXI:SLOT_3_AXI:SLOT_4_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_5_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 99990000, PHASE 0.000" *) input clk;
  ...
  wire [0:0]net_slot_4_axi_aruser;
  ...
  wire [0:0]net_slot_4_axi_awuser;
  ...
  assign Conn4_ARUSER = SLOT_4_AXI_aruser[0];
  ...
  assign Conn4_AWUSER = SLOT_4_AXI_awuser[0];
  ...
  bd_350e_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe104(net_slot_3_axi_ar_cnt),
        .probe105(net_slot_3_axi_araddr),
        .probe106(net_slot_3_axi_arburst),
        .probe107(net_slot_3_axi_arcache),
        .probe108(net_slot_3_axi_arid),
        .probe109(net_slot_3_axi_arlen),
        .probe11(net_slot_0_axi_awaddr),
        .probe110(net_slot_3_axi_arlock),
        .probe111(net_slot_3_axi_arprot),
        .probe112(net_slot_3_axi_arqos),
        .probe113(net_slot_3_axi_arsize),
        .probe114(net_slot_3_axi_aruser),
        .probe115(net_slot_3_axi_aw_cnt),
        .probe116(net_slot_3_axi_awaddr),
        .probe117(net_slot_3_axi_awburst),
        .probe118(net_slot_3_axi_awcache),
        .probe119(net_slot_3_axi_awid),
        .probe12(net_slot_0_axi_awburst),
        .probe120(net_slot_3_axi_awlen),
        .probe121(net_slot_3_axi_awlock),
        .probe122(net_slot_3_axi_awprot),
        .probe123(net_slot_3_axi_awqos),
        .probe124(net_slot_3_axi_awsize),
        .probe125(net_slot_3_axi_awuser),
        .probe126(net_slot_3_axi_b_cnt),
        .probe127(net_slot_3_axi_bid),
        .probe128(net_slot_3_axi_bresp),
        .probe129(net_slot_3_axi_r_cnt),
        .probe13(net_slot_0_axi_awcache),
        .probe130(net_slot_3_axi_rdata),
        .probe131(net_slot_3_axi_rid),
        ...
        .probe140(net_slot_4_axi_ar_cnt),
        .probe141(net_slot_4_axi_araddr),
        .probe142(net_slot_4_axi_arburst),
        .probe143(net_slot_4_axi_arcache),
        .probe144(net_slot_4_axi_arid),
        .probe145(net_slot_4_axi_arlen),
        .probe146(net_slot_4_axi_arlock),
        .probe147(net_slot_4_axi_arprot),
        .probe148(net_slot_4_axi_arqos),
        .probe149(net_slot_4_axi_arsize),
        .probe15(net_slot_0_axi_awlock),
        .probe150(net_slot_4_axi_aruser),
        .probe151(net_slot_4_axi_aw_cnt),
        .probe152(net_slot_4_axi_awaddr),
        .probe153(net_slot_4_axi_awburst),
        .probe154(net_slot_4_axi_awcache),
        .probe155(net_slot_4_axi_awid),
        .probe156(net_slot_4_axi_awlen),
        .probe157(net_slot_4_axi_awlock),
        .probe158(net_slot_4_axi_awprot),
        .probe159(net_slot_4_axi_awqos),
        .probe16(net_slot_0_axi_awprot),
        .probe160(net_slot_4_axi_awsize),
        .probe161(net_slot_4_axi_awuser),
        .probe162(net_slot_4_axi_b_cnt),
        .probe163(net_slot_4_axi_bid),
        .probe164(net_slot_4_axi_bresp),
        .probe165(net_slot_4_axi_r_cnt),
        .probe166(net_slot_4_axi_rdata),
        .probe167(net_slot_4_axi_rid),
        .probe168(net_slot_4_axi_rresp),
        .probe169(net_slot_4_axi_wdata),
        .probe17(net_slot_0_axi_awqos),
        .probe170(net_slot_4_axi_wstrb),
        .probe171(net_slot_4_axi_aw_ctrl),
        .probe172(net_slot_4_axi_w_ctrl),
        .probe173(net_slot_4_axi_b_ctrl),
        .probe174(net_slot_4_axi_ar_ctrl),
        .probe175(net_slot_4_axi_r_ctrl),
        ...
        .probe68(net_slot_2_axi_ar_cnt),
        .probe69(net_slot_2_axi_araddr),
        .probe7(net_slot_0_axi_arqos),
        .probe70(net_slot_2_axi_arburst),
        .probe71(net_slot_2_axi_arcache),
        .probe72(net_slot_2_axi_arid),
