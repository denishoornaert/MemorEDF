...
################################################################
# This is a generated script based on design: bd_f5cf
#
...
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_ports SLOT_3_AXI] [get_bd_intf_pins g_inst/slot_3_axi]
  ...
  connect_bd_net -net net_slot_1_axi_arlen [get_bd_pins g_inst/m_slot_1_axi_arlen] [get_bd_pins ila_lib/probe40]
  connect_bd_net -net net_slot_1_axi_arlock [get_bd_pins g_inst/m_slot_1_axi_arlock] [get_bd_pins ila_lib/probe41]
  connect_bd_net -net net_slot_1_axi_arprot [get_bd_pins g_inst/m_slot_1_axi_arprot] [get_bd_pins ila_lib/probe42]
  connect_bd_net -net net_slot_1_axi_arqos [get_bd_pins g_inst/m_slot_1_axi_arqos] [get_bd_pins ila_lib/probe43]
  ...
  connect_bd_net -net net_slot_1_axi_aruser [get_bd_pins g_inst/m_slot_1_axi_aruser] [get_bd_pins ila_lib/probe45]
  ...
  connect_bd_net -net net_slot_1_axi_awqos [get_bd_pins g_inst/m_slot_1_axi_awqos] [get_bd_pins ila_lib/probe53]
  connect_bd_net -net net_slot_1_axi_awready [get_bd_pins g_inst/m_slot_1_axi_awready] [get_bd_pins slot_1_aw/In1]
  connect_bd_net -net net_slot_1_axi_awsize [get_bd_pins g_inst/m_slot_1_axi_awsize] [get_bd_pins ila_lib/probe54]
  connect_bd_net -net net_slot_1_axi_awuser [get_bd_pins g_inst/m_slot_1_axi_awuser] [get_bd_pins ila_lib/probe55]
  ...
  connect_bd_net -net net_slot_1_axi_bresp [get_bd_pins g_inst/m_slot_1_axi_bresp] [get_bd_pins ila_lib/probe57]
  connect_bd_net -net net_slot_1_axi_bvalid [get_bd_pins g_inst/m_slot_1_axi_bvalid] [get_bd_pins slot_1_b/In0]
  connect_bd_net -net net_slot_1_axi_r_cnt [get_bd_pins g_inst/m_slot_1_axi_r_cnt] [get_bd_pins ila_lib/probe58]
  connect_bd_net -net net_slot_1_axi_r_ctrl [get_bd_pins ila_lib/probe67] [get_bd_pins slot_1_r/dout]
  connect_bd_net -net net_slot_1_axi_rdata [get_bd_pins g_inst/m_slot_1_axi_rdata] [get_bd_pins ila_lib/probe59]
