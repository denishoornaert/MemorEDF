...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_vip_0_M_AXI [get_bd_intf_pins MemorEDF_0/s00_axi] [get_bd_intf_pins axi_vip_0/M_AXI]

  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins MemorEDF_0/m00_axi_aclk] [get_bd_pins MemorEDF_0/s00_axi_aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_vip_1/aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins MemorEDF_0/m00_axi_aresetn] [get_bd_pins MemorEDF_0/s00_axi_aresetn] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins axi_vip_1/aresetn]
  ...
  create_bd_addr_seg -range 0x000100000000 -offset 0x004000000000 [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs MemorEDF_0/s00_axi/reg0] SEG_MemorEDF_0_reg0
