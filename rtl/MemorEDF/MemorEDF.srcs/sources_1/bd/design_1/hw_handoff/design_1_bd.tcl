...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Q_0_kill_the_core_0 [ create_bd_port -dir O Q_0_kill_the_core_0 ]
  set Q_1_kill_the_core_0 [ create_bd_port -dir O Q_1_kill_the_core_0 ]
  set Q_2_kill_the_core_0 [ create_bd_port -dir O Q_2_kill_the_core_0 ]
  set Q_3_kill_the_core_0 [ create_bd_port -dir O Q_3_kill_the_core_0 ]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins MemorEDF_0/m00_axi_aclk] [get_bd_pins MemorEDF_0/s00_axi_aclk] [get_bd_pins MemorEDF_0/s01_axi_aclk] [get_bd_pins MemorEDF_0/s02_axi_aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_vip_1/aclk] [get_bd_pins axi_vip_2/aclk] [get_bd_pins axi_vip_3/aclk] [get_bd_pins porttoportmapping_v1_0_0/m00_axi_aclk] [get_bd_pins porttoportmapping_v1_0_0/s00_axi_aclk]
