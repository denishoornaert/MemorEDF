...
//--------------------------------------------------------------------------------
//Command: generate_target bd_30d6.bd
//Design : bd_30d6
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_30d6,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_30d6,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_static_bleacher_smartconnect_0_1.hwdef" *) 
module bd_30d6
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S00_AXI, ADDR_WIDTH 49, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 0, CLK_DOMAIN design_static_bleacher_aclk_0, DATA_WIDTH 128, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 16, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [48:0]S00_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI AWADDR" *) input [48:0]S00_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI, ASSOCIATED_CLKEN s_sc_aclken, CLK_DOMAIN design_static_bleacher_aclk_0, FREQ_HZ 100000000, PHASE 0.000" *) input aclk;
  ...
  wire [48:0]s00_entry_pipeline_m_axi_ARADDR;
  ...
  wire [48:0]s00_entry_pipeline_m_axi_AWADDR;
  ...
  assign S00_AXI_1_ARADDR = S00_AXI_araddr[48:0];
  ...
  assign S00_AXI_1_AWADDR = S00_AXI_awaddr[48:0];
  ...
  m00_exit_pipeline_imp_1OZ4L6S m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_OO6UDJ s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_LGC28T s00_nodes
...
module m00_exit_pipeline_imp_1OZ4L6S
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_OO6UDJ
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  wire aclk_1;
  wire aresetn_1;
  wire [48:0]s00_mmu_M_AXI_ARADDR;
  ...
  wire [48:0]s00_mmu_M_AXI_AWADDR;
  ...
  wire [48:0]s00_si_converter_M_AXI_ARADDR;
  ...
  wire [48:0]s00_si_converter_M_AXI_AWADDR;
  ...
  wire [48:0]s00_transaction_regulator_M_AXI_ARADDR;
  ...
  wire [48:0]s00_transaction_regulator_M_AXI_AWADDR;
  ...
  assign aclk_1 = aclk;
  assign aresetn_1 = aresetn;
  assign m_axi_araddr[48:0] = s00_si_converter_M_AXI_ARADDR;
  ...
  assign m_axi_awaddr[48:0] = s00_si_converter_M_AXI_AWADDR;
  ...
  bd_30d6_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_30d6_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_30d6_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
