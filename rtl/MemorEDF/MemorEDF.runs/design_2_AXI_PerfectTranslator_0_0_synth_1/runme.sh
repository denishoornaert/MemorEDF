...
HD_PWD='/home/duck/Github/cached_memoredf/rtl/MemorEDF/MemorEDF.runs/design_2_AXI_PerfectTranslator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_AXI_PerfectTranslator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_AXI_PerfectTranslator_0_0.tcl
