...
HD_PWD='/home/duck/Github/MemorEDF/rtl/MemorEDF/MemorEDF.runs/design_6_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_6_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_6_blk_mem_gen_0_0.tcl
