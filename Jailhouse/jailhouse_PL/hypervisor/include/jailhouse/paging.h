...
struct paging_structures {
	...
	/** Reference to an array of root page tables for alternative mappings */
	page_table_t * alt_mapping_roots;
	/** Index of the current mapping used in the cell. 0 is default. */
	__u32 current_mapping;
