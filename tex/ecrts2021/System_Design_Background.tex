...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.45\linewidth]{images/system_blocks.png}
...
\emph{normal route}, depicted in \circledfig{fig:PS-PL-diagram}{5} and
...
In this paper, we leverage the PLIM approach to perform memory
...
\fig{fig:axi_transaction_scheme_figure}.
...
attributes the type/length of the burst, and so on.  Upon completing this phase, follows the data phase \circled{2}, which
consists of the transmission of the data payload to be written through
the W channel.  The response phase \circled{3} concludes a successful write transaction and occurs on the B channel.
