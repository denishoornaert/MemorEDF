...
full-system soft-core implementation. \replace{Both cases are considerably slower
than what it would be in real systems and force the use of an unrealistically
lightweight workload. Nonrealistic workloads limit the repeatability of
experiments of scale.}{Both cases have their drawbacks. The former gives a
great deal of flexibility but has to simulate many parts of the SoC. In addition,
simulated setups can hardly be applied on real platforms unless they rely on
soft-core implementation. Full soft-core based SoC implementations suffer from
two shortcomings. First, they run a low frequency and thus cannot put enough
pressure on the DRAM controller. Secondly, they rely on soft-core implementations
that do not exploit the same Instructions Set Architecture as widely available
COTS, limiting the practical impacts of these works.}
