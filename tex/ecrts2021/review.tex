...
%        \subsubsection{It is not clear to me whether the evaluation correctly reflects the performance of the baseline.}
    ...
    \subsection{Reviewer C}
        ...
        that for a PL operating at 250~MHz (the \schim frequency), and
        with a bus width of 128~bits, a full-duplex throughput of
        approximately 3.7~GBps can be sustained. This is in line with
        the throughput of 4.8~GBps (for 300~MHz) reported
        in~\cite{uiuc-xilinx-port-study}.  Finally, while the Cortex
        A53 cores run at 1.5~GHz, the main PS-side bus runs at a much
        lower frequency, i.e. 500~MHz. This frequency is closer to the
...
%       interference of these memory controller schedulers.}
    ...
    \subsection{Second round of shepherding}
        \subsubsection{Performance Degradation}
            ...
            Slightly extend the Discussion section 7
