...
%        %\IEEEauthorrefmark{1}\textit{Department of Mechanical Engineering, Technical University of Munich}\\
%        %\IEEEauthorrefmark{2}\textit{Department of Mobility Engineering, Federal University of Santa Catarina}\\
