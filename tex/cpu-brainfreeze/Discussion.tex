...
%    With the ARM Cortex-A53 \cite{ARM-cortex-A53} reported issuing capability of up to 37 transactions, the fact that a single unserved transaction occupying one MSHR is capable of introducing substantial inter-core interference is an unexpected result.
