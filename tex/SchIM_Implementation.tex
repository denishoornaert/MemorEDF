...
%% RM: The following belongs to the implmentation IMHO
%% Like any other interrupt source in the system, a unique ID number
%% identifies each of the PL-PS interrupts lines. Hence, by providing
%% proper handlers associated with specific interrupt ID lines and
%% unmasking them, PL can request a desired service routine from the
%% PS. Nevertheless, as PS is buttressed by Arm Cortex-A53 Based
